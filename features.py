...
class METRIC(object):
    def __init__(self, title, sentences, agent, simWithTitle, simWithDoc, sim2sents, number_of_nouns, simWithAbs, order_params):
        self.title = title
...
def compute_fitness(title, sentences, agent, simWithTitle, simWithDoc, sim2sents, number_of_nouns, simWithAbs, order_params):
    metric = METRIC(title, sentences, agent, simWithTitle,
                    simWithDoc, sim2sents, number_of_nouns,simWithAbs, order_params)
    # return metric.GLS()
